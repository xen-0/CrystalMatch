...
class FeatureMatcher:
    ...
    'orb.detectAndCompute()' does not work properly for Python - it incorrectly
    ...
    def _draw_matches(img1, kp1, img2, kp2, matches):
        """ Based on original from from: http://stackoverflow.com/questions/20259025/module-object-has-no-attribute-drawmatches-opencv-python
    ...
    def perform_match(self):
        ...
        kp1, des1 = orb.detectAndCompute(img1.img, None)
        kp2, des2 = orb.detectAndCompute(img2.img, None)
