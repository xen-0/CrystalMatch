...
from PyQt4.QtCore import Qt, pyqtBoundSignal
...
class BoolConfigControl(ConfigControl):
    ...
    def update_from_config(self):
        state = 2 if self._config_item.value() else 0
...
class EnumConfigControl(ConfigControl):
    ...
    def _init_ui(self):
        ...
        index = self._cmbo_enum.findText(selected, Qt.MatchFixedString)
...
class DirectoryConfigControl(ConfigControl):
    ...
    def _init_ui(self):
        ...
        assert (isinstance(btn_show.clicked, pyqtBoundSignal))
...
class ColorConfigControl(ConfigControl):
    ...
    def _init_ui(self):
        ...
        assert (isinstance(self._swatch.clicked, pyqtBoundSignal))
